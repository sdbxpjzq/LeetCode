...
public class DoubleLinkedListDemo {
    ...
    public static void main(String[] args) {
        ...
        Node hero5 = new Node(5, "卢俊义5", "玉麒麟5");
        // 创建一个双向链表
        ...
        doubleLinkedList.addByOderBy(hero1);
        doubleLinkedList.addByOderBy(hero2);
        doubleLinkedList.addByOderBy(hero3);
        doubleLinkedList.addByOderBy(hero4);
        doubleLinkedList.addByOderBy(hero5);
...
class DoubleLinkedList {
     ...
     * @param heroNode
     */
    public void addByOderBy(Node heroNode) {
        Node temp = head;
        boolean flag = false;
        while (temp.next != null) {
