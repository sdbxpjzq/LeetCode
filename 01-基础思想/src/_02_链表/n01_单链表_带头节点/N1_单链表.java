...
*/
    ...
    /**
     * todo 面试题 获取到单链表的节点的个数(如果是带头结点的链表，需求不统计头节点)
     * @param head 链表的头节点
     * @return 返回的就是有效节点的个数
     */
...
class SingleLinkedList {
    // todo 先初始化一个头节点, 头节点不要动, 不存放具体的数据
